...
public class StringDemo3 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Removed the spaces before and after the String but not the ones which are present in between
		 */
		...
		System.out.println(str2.endsWith("y")); // "easy"
		/*
		 * Method chaining helps us call multiple methods on a single line on method after another
		 */
		System.out.println(str2.toLowerCase().contains("very")); //converts the word to lower case.
	}
